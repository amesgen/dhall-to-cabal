  ...
  where
    ...
    factorBuildInfo fields =
      let
        ...
        fields' = Dhall.Core.makeRecordField <$> fields
      in
        if | null shared
           ...
           | otherwise
             -> Expr.Prefer Dhall.Core.PreferFromSource -- TODO
                  ( resolve ( PreludeDefault BuildInfo ) )
...
generaliseDeclared :: Dhall.Encoder a -> Expr.Expr s b
generaliseDeclared =
...
libraryDefault named resolve = buildInfoDefault resolve <> specificFields
  where
    ...
    visibility = Dhall.Core.makeFieldSelection $ if named
      then "private"
      else "public"
...
packageDefault resolve = fields
  where
    named name typ = Expr.Record
      ( Map.fromList
          [ ( "name"
            , Dhall.Core.makeRecordField Expr.Text
            )
          , ( name
    ...
    fields = Map.fromList
      ...
      , emptyListDefault "tested-with"
          ( Expr.Record
              ( Map.fromList
                  [ ( "compiler", Dhall.Core.makeRecordField $ generaliseDeclared compilerFlavor )
                  , ( "version", Dhall.Core.makeRecordField $ generaliseDeclared versionRange )
                  ]
              )
          )
      , emptyListDefault "x-fields"
          ( Expr.Record
              ( Map.fromList
                  [ ( "_1", Dhall.Core.makeRecordField Expr.Text ), ( "_2", Dhall.Core.makeRecordField Expr.Text ) ]
              )
          )
...
withDefault typ defs ( Expr.RecordLit fields ) =
  let -- TODO recordFieldValue
    nonDefaults = nonDefaultFields ( defs resolvePreludeVar ) $ Dhall.Core.recordFieldValue <$> fields
    name = Dhall.Core.makeFieldSelection $ StrictText.pack ( show typ )
  in
    if null nonDefaults
    then Expr.Var ( Expr.V "prelude" 0 ) `Expr.Field` Dhall.Core.makeFieldSelection "defaults" `Expr.Field` name
    else Expr.Prefer
          -- TODO
           Dhall.Core.PreferFromSource
           ( Expr.Var ( Expr.V "prelude" 0 ) `Expr.Field` Dhall.Core.makeFieldSelection "defaults" `Expr.Field` name )
...
runRecordInputType ( RecordInputType m ) =
  Dhall.Encoder
    { Dhall.embed =
        \a -> sortExpr ( Expr.RecordLit ( Dhall.Core.makeRecordField <$> fmap ( \t -> Dhall.embed t a ) m ) )
    , Dhall.declared = sortExpr ( Expr.Record ( Dhall.Core.makeRecordField <$> fmap Dhall.declared m ) )
    }
...
packageDescriptionToRecord =
  mconcat
    ...
    , recordField "license-files" ( contramap Cabal.licenseFiles ( listOf Dhall.inject ) )
    ...
    , recordField "data-files" ( contramap Cabal.dataFiles ( listOf Dhall.inject ) )
    , recordField "data-dir" ( contramap Cabal.dataDir Dhall.inject )
    , recordField "extra-source-files" ( contramap Cabal.extraSrcFiles ( listOf Dhall.inject ) )
    , recordField "extra-tmp-files" ( contramap Cabal.extraTmpFiles ( listOf Dhall.inject ) )
    , recordField "extra-doc-files" ( contramap Cabal.extraDocFiles ( listOf Dhall.inject ) )
    , recordField
        "x-fields"
        ( Cabal.customFieldsPD
            >$<
              listOf
                ( runRecordInputType
                    ( mconcat
                        [ fst >$< recordField "_1" Dhall.inject
                        , snd >$< recordField "_2" Dhall.inject
                        ]
                    )
                )
        )
...
packageNameToDhall =
  contramap Cabal.unPackageName Dhall.inject
...
-- TODO rename
stringToDhall :: Dhall.Encoder Cabal.ShortText
stringToDhall =
  contramap Cabal.fromShortText Dhall.inject
...
licenseToDhall =
  ...
  where
    license name =
      Expr.App
        ( Expr.Var "types" `Expr.Field` Dhall.Core.makeFieldSelection "License" `Expr.Field` Dhall.Core.makeFieldSelection name )
    licenseNullary name =
      Expr.Var "types" `Expr.Field` Dhall.Core.makeFieldSelection "License" `Expr.Field` Dhall.Core.makeFieldSelection name
                ...
                Nothing ->
                  Expr.App
                    ( Expr.App
                        ...
                        ( Dhall.embed Dhall.inject ( SPDX.licenseRef ref ) )
                    )
                    ( Dhall.embed ( maybeToDhall spdxLicenseExceptionIdToDhall ) exceptionMay )
                Just file ->
                  Expr.App
...
compilerFlavor =
  let
    constructor k v =
      Expr.App ( Expr.Var "types" `Expr.Field` Dhall.Core.makeFieldSelection "Compiler" `Expr.Field` Dhall.Core.makeFieldSelection k ) v
    nullary k =
      Expr.Var "types" `Expr.Field` Dhall.Core.makeFieldSelection "Compiler" `Expr.Field` Dhall.Core.makeFieldSelection k
...
sourceRepo =
  ( runRecordInputTypeWithDefault SourceRepo sourceRepoDefault
      ( mconcat
          ...
          , recordField "location" ( contramap Cabal.repoLocation ( maybeToDhall Dhall.inject ) )
          , recordField "module" ( contramap Cabal.repoModule ( maybeToDhall Dhall.inject ) )
          , recordField "branch" ( contramap Cabal.repoBranch ( maybeToDhall Dhall.inject ) )
          , recordField "tag" ( contramap Cabal.repoTag ( maybeToDhall Dhall.inject ) )
          , recordField "subdir" ( contramap Cabal.repoSubdir ( maybeToDhall Dhall.inject ) )
          ]
      )
  )
  { Dhall.declared =
...
repoType =
  ...
  where
    constr name =
      Expr.Var "types" `Expr.Field` Dhall.Core.makeFieldSelection "RepoType" `Expr.Field` Dhall.Core.makeFieldSelection name
...
flag =
  runRecordInputType
    ( mconcat
        ...
        , recordField "description" ( contramap Cabal.flagDescription Dhall.inject )
...
flagName =
  contramap Cabal.unFlagName Dhall.inject
...
condTree t =
  ...
  Dhall.Encoder
    { Dhall.embed =
        Expr.Lam (Dhall.Core.makeFunctionBinding "config" configRecord)
          . go
          . unifyCondTree
    , Dhall.declared =
...
moduleName =
  contramap ( show . Cabal.pretty ) Dhall.inject
...
arch =
  ...
  where
  arch name =
    Expr.Var "types" `Expr.Field` Dhall.Core.makeFieldSelection "Arch" `Expr.Field` Dhall.Core.makeFieldSelection name
...
buildInfoRecord =
  mconcat
    ...
    , recordField "cpp-options" ( contramap Cabal.cppOptions ( listOf Dhall.inject ) )
    , recordField "cc-options" ( contramap Cabal.ccOptions ( listOf Dhall.inject ) )
    , recordField "ld-options" ( contramap Cabal.ldOptions ( listOf Dhall.inject ) )
    , recordField "pkgconfig-depends" ( contramap Cabal.pkgconfigDepends ( listOf pkgconfigDependency ) )
    , recordField "frameworks" ( contramap Cabal.frameworks ( listOf Dhall.inject ) )
    , recordField "extra-framework-dirs" ( contramap Cabal.extraFrameworkDirs ( listOf Dhall.inject ) )
    , recordField "c-sources" ( contramap Cabal.cSources ( listOf Dhall.inject ) )
    , recordField "js-sources" ( contramap Cabal.jsSources ( listOf Dhall.inject ) )
    , recordField "hs-source-dirs" ( contramap Cabal.hsSourceDirs ( listOf Dhall.inject ) )
    ...
    , recordField "extra-libraries" ( Cabal.extraLibs >$< listOf Dhall.inject )
    , recordField "extra-ghci-libraries" ( Cabal.extraGHCiLibs >$< listOf Dhall.inject )
    , recordField "extra-lib-dirs" ( Cabal.extraLibDirs >$< listOf Dhall.inject )
    , recordField "include-dirs" ( Cabal.includeDirs >$< listOf Dhall.inject )
    , recordField "includes" ( Cabal.includes >$< listOf Dhall.inject )
    , recordField "install-includes" ( Cabal.installIncludes >$< listOf Dhall.inject )
    ...
    , recordField "asm-options" ( Cabal.asmOptions >$< listOf Dhall.inject)
    , recordField "asm-sources" ( Cabal.asmSources >$< listOf Dhall.inject)
    , recordField "cmm-options" ( Cabal.cmmOptions >$< listOf Dhall.inject )
    , recordField "cmm-sources" ( Cabal.cmmSources >$< listOf Dhall.inject )
    , recordField "cxx-options" ( Cabal.cxxOptions >$< listOf Dhall.inject )
    , recordField "cxx-sources" ( Cabal.cxxSources >$< listOf Dhall.inject)
    , recordField "virtual-modules" ( Cabal.virtualModules >$< listOf moduleName )
    , recordField "extra-lib-flavours" ( Cabal.extraLibFlavours >$< listOf Dhall.inject )
    , recordField "extra-bundled-libs" ( Cabal.extraBundledLibs >$< listOf Dhall.inject )
    , recordField "autogen-includes" ( Cabal.autogenIncludes >$< listOf Dhall.inject )
    , recordField "extra-dyn-lib-flavours" ( Cabal.extraDynLibFlavours >$< listOf Dhall.inject )
    ]
...
legacyExeDependency =
  runRecordInputType
    ( mconcat
        [ recordField "exe" ( ( \( Cabal.LegacyExeDependency exe _ ) -> exe ) >$< Dhall.inject )
...
unqualComponentName =
  show . Cabal.pretty >$< Dhall.inject
...
language =
  ...
  where
    lang name =
      Expr.Var "types" `Expr.Field` Dhall.Core.makeFieldSelection "Language" `Expr.Field` Dhall.Core.makeFieldSelection name
...
compilerOptions =
  ( runRecordInputTypeWithDefault CompilerOptions compilerOptionsDefault
      ( mconcat
          [ recordField "GHC" ( (\ ( Cabal.PerCompilerFlavor ghc _ ) -> ghc ) >$< listOf Dhall.inject )
          , recordField "GHCJS" ( (\ ( Cabal.PerCompilerFlavor _ ghcjs ) -> ghcjs ) >$< listOf Dhall.inject )
          ]
      )
  )
    { Dhall.declared =
                ...
                ( Expr.ListLit
                    ...
                    ( fmap
                        (\ ( src, dst ) ->
                           Expr.RecordLit
                             ( Map.fromList
                                 [ ( "rename", Dhall.Core.makeRecordField $ Dhall.embed moduleName src )
                                 , ( "to", Dhall.Core.makeRecordField $ Dhall.embed moduleName dst )
                                 ]
                             )
                        )
  ...
  (  runRecordInputTypeWithDefault Benchmark benchmarkDefault
       ( mconcat
           [ recordField "main-is" (
              ...
              . Cabal.benchmarkInterface >$< Dhall.inject
              )
    ...
    { Dhall.embed = \case
        Cabal.TestSuiteExeV10 _ main ->
          Expr.App
            ...
            ( Dhall.embed
              ( runRecordInputType ( recordField "main-is" Dhall.inject ) )
              main
            )
        Cabal.TestSuiteLibV09 _ m ->
          Expr.App
            ...
            -- TODO TestSuiteUnsupported
    , Dhall.declared =
        Expr.Var "types" `Expr.Field` Dhall.Core.makeFieldSelection "TestType"
    }
  where
  interface name =
    Expr.Var "types" `Expr.Field` Dhall.Core.makeFieldSelection "TestType" `Expr.Field` Dhall.Core.makeFieldSelection name
...
executable =
  ( runRecordInputTypeWithDefault Executable executableDefault
      ( mconcat
          [ recordField "main-is" ( Cabal.modulePath >$< Dhall.inject )
...
foreignLibrary =
  ( runRecordInputType
      ( mconcat
          ...
          , recordField "mod-def-files" ( Cabal.foreignLibModDefFile >$< listOf Dhall.inject )
          ]
      )
  )
    { Dhall.declared =
  ...
  Dhall.Encoder
    { Dhall.embed = \case
        ...
        Cabal.ForeignLibNativeStatic ->
          ty "Static"
          -- TODO ForeignLibTypeUnknown
    , Dhall.declared =
        Expr.Var "types" `Expr.Field` Dhall.Core.makeFieldSelection "ForeignLibType"
    }
  where
  ty name =
    Expr.Var "types" `Expr.Field` Dhall.Core.makeFieldSelection "ForeignLibType" `Expr.Field` Dhall.Core.makeFieldSelection name
